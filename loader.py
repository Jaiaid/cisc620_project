...
time1 = execute_sql_file(
    '/Users/darian/Desktop/School/RITCS/BigData/grp4/phase1/cctables.sql')
    
print("RUNNING: updtables.sql")
# Edit for the correct path to updatetables.sql on your system
time2 = execute_sql_file(
    '/Users/darian/Desktop/School/RITCS/BigData/grp4/phase1/updtables.sql')
